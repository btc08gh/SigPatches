...
Path("./patches/atmosphere/exefs_patches/d2r_offline_fix").mkdir(parents=True, exist_ok=True)
...
with open('main', 'rb') as fi:
    ...
    text_file = open("patches/atmosphere/exefs_patches/d2r_offline_fix/" + get_build_id() + ".ips", "wb")
