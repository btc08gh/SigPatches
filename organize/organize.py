...
for version in os.listdir("."):
    ...
    with open(exfatuncompressed, 'rb') as fi1:
        ...
        text_file = open('../SigPatches/atmosphere/kip_patches/fs_patches/%s.ips' % exfathash, 'wb')
        ...
        text_file = open('../SigPatches/atmosphere/kip_patches/fs_patches/%s.ips' % fat32hash, 'wb')
        text_file.write(bytes.fromhex(str("5041544348" + patch1 + patch2 + "454F46")))
        text_file.close()
