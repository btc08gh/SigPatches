...
for version in os.listdir("."):
    ...
    text_file = open("../patches/atmosphere/exefs_patches/es_patches/" + get_es_build_id() + ".ips", "wb")
    ...
    text_file = open("../patches/atmosphere/exefs_patches/nifm_ctest/" + get_nifm_build_id() + ".ips", "wb")
    ...
    with open(exfatuncompressed, 'rb') as fi1:
        ...
        text_file = open('../patches/atmosphere/kip_patches/fs_patches/%s.ips' % exfathash, 'wb')
        ...
        text_file = open('../patches/atmosphere/kip_patches/fs_patches/%s.ips' % fat32hash, 'wb')
        text_file.write(bytes.fromhex(str("5041544348" + patch1 + patch2 + "454F46")))
        text_file.close()
